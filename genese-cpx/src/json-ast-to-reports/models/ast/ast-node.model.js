...
var AstNode = /** @class */ (function () {
    function AstNode() {
        ...
        this._lineStart = undefined; // The issue of the line containing the character at the AstNode.extractHooksAndArrowFunctions
        this._name = undefined; // The name of the AstNode
        this._pos = 0; // The pos of the beginning of the AST node, including spaces and comments before it. (extractHooksAndArrowFunctions <= extractHooksAndArrowFunctions)
        this._start = 0; // The pos of the beginning of the AST node, without spaces and comments before it. (extractHooksAndArrowFunctions >= extractHooksAndArrowFunctions)
    ...
    Object.defineProperty(AstNode.prototype, "hasArrowFunctionDescendant", {
        get: function () {
            return !!ast_service_1.Ast.getFirstDescendantOfKind(this, syntax_kind_enum_1.SyntaxKind.ArrowFunction);
        },
        enumerable: false,
        configurable: true
    });
    ...
    Object.defineProperty(AstNode.prototype, "isAssignment", {
        get: function () {
            return [node_feature_enum_1.NodeFeature.VARIABLE, node_feature_enum_1.NodeFeature.PARAMETER].includes(this.factorCategory);
        },
        enumerable: false,
        configurable: true
    });
    ...
    Object.defineProperty(AstNode.prototype, "isExpressionStatement", {
        get: function () {
            return ast_service_1.Ast.isExpressionStatement(this);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(AstNode.prototype, "isCallDeclaration", {
        get: function () {
            return this.factorCategory === node_feature_enum_1.NodeFeature.CALL_DECLARATION;
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(AstNode.prototype, "isIdentifier", {
        get: function () {
            return ast_service_1.Ast.isIdentifier(this);
        },
        enumerable: false,
        configurable: true
    });
    ...
    Object.defineProperty(AstNode.prototype, "isVarArrowFunction", {
        get: function () {
            var _a, _b, _c;
            var ancestor = (_b = (_a = this.parent) === null || _a === void 0 ? void 0 : _a.parent) === null || _b === void 0 ? void 0 : _b.parent;
            return this.kind === 'ArrowFunction' && (ancestor === null || ancestor === void 0 ? void 0 : ancestor.kind) === 'VariableStatement' && ((_c = ancestor.parent) === null || _c === void 0 ? void 0 : _c.kind) === 'SourceFile';
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(AstNode.prototype, "isVarStatement", {
        get: function () {
            return ast_service_1.Ast.isVarStatement(this);
        },
        enumerable: false,
        configurable: true
    });
    ...
    Object.defineProperty(AstNode.prototype, "shouldBeTyped", {
        get: function () {
     ...
     * @private
     */
    AstNode.prototype.setTypingCpxFactors = function () {
        if (this.shouldBeTyped && !this.type) {
            var category = this.isCallDeclaration ? 'func' : this.factorCategory;
            this.cpxFactors.typing[category] = cpx_factors_1.cpxFactors.typing[category];
        }
    };
    /**
     ...
     * @private
     */
    AstNode.prototype.setArrowFunctionStructuralCpx = function () {
