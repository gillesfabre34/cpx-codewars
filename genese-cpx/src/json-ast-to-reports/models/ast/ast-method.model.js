...
var AstMethod = /** @class */ (function () {
    ...
    Object.defineProperty(AstMethod.prototype, "isArrowFunction", {
        get: function () {
            return this._isArrowFunction;
        },
        set: function (isArrowFunction) {
     ...
     */
    AstMethod.prototype.createDisplayedCodeAndCalculateCpxFactors = function (astNode) {
    ...
    AstMethod.prototype.calculateCpxFactors = function () {
        var _a, _b;
        var lines = (_a = this._displayedCode) === null || _a === void 0 ? void 0 : _a.lines;
        if (lines.length === 0) {
            this.createDisplayedCodeAndCalculateCpxFactors();
        }
        this.cpxFactors = new cpx_factors_model_1.CpxFactors();
        for (var _i = 0, _c = (_b = this._displayedCode) === null || _b === void 0 ? void 0 : _b.lines; _i < _c.length; _i++) {
            var line = _c[_i];
