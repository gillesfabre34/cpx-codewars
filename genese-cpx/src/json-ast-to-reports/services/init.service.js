...
var arrow_functions_service_1 = require("./ast/arrow-functions.service");
/**
...
var InitService = /** @class */ (function () {
    ...
    InitService.prototype.generateAstFile = function (astFileFromJsonAst, astFolder) {
        ...
        var arrowFunctions = arrow_functions_service_1.ArrowFunctionsService.getArrowFunctions(newAstFile.astNode);
