...
var arrays_util_1 = require("../../../core/utils/arrays.util");
/**
...
var Ast = /** @class */ (function () {
     ...
     * @param astNode   // The AST node to check
     */
    Ast.isExpressionStatement = function (astNode) {
        var _a;
        return (_a = (astNode === null || astNode === void 0 ? void 0 : astNode.kind) === syntax_kind_enum_1.SyntaxKind.ExpressionStatement) !== null && _a !== void 0 ? _a : false;
    };
    /**
     * Checks if an AST node is a VariableStatement
     * @param astNode   // The AST node to check
     */
    Ast.isVarStatement = function (astNode) {
        var _a;
        return (_a = (astNode === null || astNode === void 0 ? void 0 : astNode.kind) === syntax_kind_enum_1.SyntaxKind.VariableStatement) !== null && _a !== void 0 ? _a : false;
    };
    /**
    ...
    Ast.getFirstChildOfKind = function (astNode, kind) {
        return astNode.children.find(function (c) { return c.kind === kind; });
    };
    // TODO: Remove duplicated code with ast.util.ts
    Ast.getFirstDescendantOfKind = function (astNode, kind) {
        if (!astNode.children) {
            return undefined;
        }
        var child = this.getFirstChildOfKind(astNode, kind);
        return child !== null && child !== void 0 ? child : this.getFirstDescendantOfAstNodeArrayOfKind(astNode.children, kind);
    };
    // TODO: Remove duplicated code with ast.util.ts
    Ast.getFirstDescendantOfAstNodeArrayOfKind = function (astNodes, kind) {
        ...
        return this.getFirstDescendantOfAstNodeArrayOfKind(arrays_util_1.flat(astNodes.map(function (a) { return a.children; })), kind);
    };
    return Ast;
}());
exports.Ast = Ast;
