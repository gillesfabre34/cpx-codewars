    ...
    FactorCategoryService.prototype.getNodeFeature = function (syntaxKind) {
        switch (syntaxKind) {
            ...
            case syntax_kind_enum_1.SyntaxKind.MethodDeclaration:
                return node_feature_enum_1.NodeFeature.CALL_DECLARATION;
            ...
            case syntax_kind_enum_1.SyntaxKind.Parameter:
                return node_feature_enum_1.NodeFeature.PARAMETER;
            ...
            case syntax_kind_enum_1.SyntaxKind.VariableStatement:
                return node_feature_enum_1.NodeFeature.VARIABLE;
            default:
