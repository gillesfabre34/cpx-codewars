...
var typing_cpx_model_1 = require("./typing-cpx.model");
/**
...
var CpxFactors = /** @class */ (function () {
    function CpxFactors() {
        ...
        this.typing = new typing_cpx_model_1.TypingCpx(); // Typing Complexity
    ...
    Object.defineProperty(CpxFactors.prototype, "totalTyping", {
        get: function () {
            return this.totalByFactorCategory(factor_category_enum_1.FactorCategory.TYPING);
        },
        enumerable: false,
        configurable: true
    });
