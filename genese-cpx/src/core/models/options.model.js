...
var framework_type_1 = require("../types/framework.type");
...
var Options = /** @class */ (function () {
     ...
     */
    Options.setOptions = function (pathCommand, pathFolderToAnalyze, pathGeneseNodeJs, framework) {
        if (framework_type_1.isFramework(framework)) {
    ...
    Options.ignoreRegex = '';
    Options.pathCommand = ''; // The path of the folder where the command-line was entered (can't be overridden)
    Options.pathFolderToAnalyze = './'; // The path of the folder to analyse (can be overridden)
    Options.pathGeneseNodeJs = ''; // The path of the node_module Genese in the nodejs user environment (can't be overridden)
    Options.pathOutDir = ''; // The path where the reports are created (can be overridden)
    Options.framework = undefined; // The framework eventually specified
    return Options;
}());
