        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    spinner.succeed();
                    if (!(LANGUAGE === language_enum_1.Language.TS && !ENABLE_CONSOLE_REPORT && ENABLE_REFACTORING)) return [3 /*break*/, 4];
                    spinner.start('Refactoring generation');
                    return [4 /*yield*/, useWorker(__dirname + "/workers/refactoring-worker.js", {
                            pathCommand: options_model_1.Options.pathCommand,
                            modifiedPath: pathToAnalyse,
                            pathGeneseNodeJs: __dirname,
                ...
                case 3:
                    ...
                    _a.label = 4;
                case 4:
                    file_service_1.deleteFile('./ast.json');
